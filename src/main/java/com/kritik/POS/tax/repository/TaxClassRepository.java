...
public interface TaxClassRepository extends JpaRepository<TaxClass, Long> {
    ...
    Optional<TaxClass> findByRestaurantIdAndCodeAndIsDeletedFalse(Long restaurantId, String code);
    ...
    @Query("""
            ...
            """)
    Page<TaxClass> findVisible(@Param("skipRestaurantFilter") boolean skipRestaurantFilter,
                               @Param("restaurantIds") Collection<Long> restaurantIds,
                               @Param("isActive") Boolean isActive,
                               @Param("search") String search,
                               Pageable pageable);

    List<TaxClass> findAllByRestaurantIdAndIsDeletedFalse(Long restaurantId);
}
