...
public class OrderV2Response {
    ...
    private List<OrderSaleItemResponse> saleItems;
    private List<ConfiguredSaleItemResponse> configuredItems;
    private List<OrderTaxSummaryResponse> taxSummaries;
    private List<OrderLineTaxResponse> lineTaxes;

    public OrderV2Response(Order order,
                           List<OrderSaleItemResponse> saleItems,
                           List<ConfiguredSaleItemResponse> configuredItems,
                           String message,
                           String description) {
        ...
        this.lineTaxes = order.getOrderLineTaxes().stream().map(OrderLineTaxResponse::fromEntity).toList();
    }
}
